...
\]
for the spent value \(v^{\mathrm{old}}\) and created value \(v^{\mathrm{new}}\) of that Action (\emph{Orchard Guide}), and the net commitment is the plain sum \(B = \sum_i \mathrm{cv}^{\mathrm{net},i}\) over the transaction's Actions. In either case, by homomorphism,
\[
