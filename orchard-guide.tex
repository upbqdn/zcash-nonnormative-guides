...
every one of those siblings is either itself a public leaf or a hash of public leaves. Hence anyone holding
...
sibling hash beside it: the \emph{authentication path} $L_3, A, F$ (blue).
...
(the \emph{Crypto Guide}) reduces a Schnorr forger to a DL adversary, and
