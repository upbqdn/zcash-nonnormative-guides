...
layer $\ell'$ is
\[
\mathsf{MerkleCRH}^{\mathsf{Orchard}}_{\ell'}(\ell, r) := \mathsf{ShortHash}_{\mathtt{z.cash:Orchard\text{-}MerkleCRH}}(\mathrm{LE}_{10}(\ell') \,\|\, \ell \,\|\, r) \;\in\; \F_{p_{\Pallas}},
\]
...
a non-trivial linear relation among $G^{\mathsf{nf}}, \cmsym, \cmsym'$. Since
