...
\emph{The Zcash Arboretum} documents the
...
\emph{Ironwood Guide} constructs in ``Keys: capabilities for spending and
...
(\emph{Ironwood Guide}, ``Transmission and detection of a note''), which is
...
\emph{unified} container encodings. The \emph{Ironwood Guide} (``Keys:
...
\emph{diversifier} $d$ per address. The \emph{Ironwood Guide} (``Keys:
...
spends one note \emph{and} creates one (the \emph{Ironwood Guide}, ``A
...
The synchronisation procedure of the \emph{Ironwood Guide} (\S~``Transmission
...
witness derivation are those of the \emph{Ironwood Guide} (\S~``Proof of
...
witness (the \emph{Ironwood Guide}, \S~``Proof of ownership of \emph{some}
...
of the \emph{Ironwood Guide} (\S~``Conservation of value\dots'' for
...
ZIP-244 construction of the \emph{Ironwood Guide} (the transaction
...
\emph{Ironwood Guide} (\textsf{orchard}, \texttt{src/pczt/prover.rs}).
\end{construction}
...
\emph{Ironwood Guide} assembles this tree in full (``The transaction digest
...
compact-block trial decryption of the \emph{Ironwood Guide} (``Transmission
...
is fully scanned (witness data exists --- the \emph{Ironwood Guide}, ``Proof
