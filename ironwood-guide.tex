...
implementation and the specification --- here crate \texttt{orchard} at \texttt{bef8a27}
(crates.io; the version \texttt{librustzcash} pins), \texttt{librustzcash} at
...
component
hashes the empty string under its personalisation (ZIP-229; deployed in
crate \texttt{orchard} at \texttt{bef8a27}, \texttt{bundle/commitments.rs}, and in
\texttt{zcash\_primitives}, \texttt{transaction/txid.rs}). One structural change
